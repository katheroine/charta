class Project < ActiveRecord::Base
  ...
  validates :state, :presence => :true, :inclusion => STATE
  ...
  validates :construction_img, :presence => { :true, :if => "state == 'under construction' || state == 'completed'", :false, :if => "state == 'at the planning stage'" }
